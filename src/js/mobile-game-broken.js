...
class MobileWordGame {
    ...
    showWordFoundAnimation(word) {
        ...
        animation.innerHTML = `
            ...
            <div class="word-score">+${score}</div>
        `;
        ...
        animation.style.cssText = `
            ...
            font-size: 1.2rem;
            z-index: 2000;
            animation: wordScore 1s ease-out forwards;
        ...
        const resultsHTML = `
            <div class="game-results-modal">
                ...
                <div class="results-stats">
                    ...
                    <div class="stat-item">
                        <span class="stat-label">Bulunan Kelime</span>
                        <span class="stat-value">${this.gameState.foundWords.length}</span>
                    </div>
                    <div class="stat-item">
                        <span class="stat-label">En İyi Kombo</span>
                        <span class="stat-value">${this.gameState.maxCombo}</span>
                    </div>
                    <div class="stat-item">
                ...
                <div class="found-words-summary">
                    ...
                    <div class="words-summary">
                        ${this.gameState.foundWords.map(word => `<span class="word-tag">${word}</span>`).join('')}
                    </div>
                </div>
                <div class="results-actions">
                    <button class="btn btn-primary" onclick="game.playAgain()">Tekrar Oyna</button>
                    <button class="btn btn-secondary" onclick="game.showScreen('mainMenu')">Ana Menü</button>
                </div>
            </div>
        `;
    ...
    showConfirmExit() {
        const confirmHTML = `
            <div class="confirm-exit-modal">
                <h3>Oyundan Çık</h3>
                <p>Oyun devam ediyor. Çıkmak istediğinizden emin misiniz?</p>
                <div class="confirm-actions">
                    <button class="btn btn-secondary" onclick="game.closeModal()">İptal</button>
                    <button class="btn btn-error" onclick="game.leaveGame()">Çık</button>
                </div>
            </div>
        `;
    ...
    initializeWordDatabase() {
        return {
            ...
            bilim: [
                ...
                { word: 'BİYOLOJİ', hint: 'Yaam bilimi', letters: ['B', 'İ', 'Y', 'O', 'L', 'O', 'J', 'İ'] },
